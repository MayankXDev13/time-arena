    ...
    <div className="space-y-4">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-3xl font-bold text-white tracking-tight">{formatDuration(totalTodaySeconds)}</p>
          <p className="text-xs text-zinc-500 font-medium">{sessionsToday} sessions</p>
        </div>
      </div>
    </div>
  );
